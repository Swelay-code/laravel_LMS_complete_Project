        ...
        <div class="row g-4 justify-content-center">
            <div class="col-12 col-md-9 col-xs-12 col-sm-12">
                ...
                <div class="mt-2 bg-body2 p-3 wow fadeInUp">
                    <h4>Video Editing Course Description:</h4>
                    
                    @include('layout.videodescription')
                    <br>
                    <p>
                        Duration: <i class="alert alert-danger">10 Weeks</i> 2 days per a week.
                    </p>
                </div>
            </div>
                ...
                <div class="position-sticky top-0 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <div class="playlist-selector">
                        ...
                        <ul class="list-group border-0 p-0 mt-1">
                            <li class="list-group-item border-0 bg-secondary text-white">Video Editing with Premiere Pro</li>
