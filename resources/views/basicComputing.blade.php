        ...
        <div class="row g-4 justify-content-center">
            <div class="col-12 col-md-9 col-xs-12 col-sm-12">
                ...
                <div class="mt-2 bg-body2 p-3 wow fadeInUp">
                    <h4>Basic Computer Course Description:</h4>
                    <p style="text-align: justify;">
                        Get started with Microsoft Word! This introductory course covers essential skills for creating, formatting, and editing documents in Word. Learn to navigate the interface, format text, insert graphics, and more. Perfect for beginners or those needing a refresher.
                    </p>
                    <br>
                    <p>
                        Duration: <i class="alert alert-danger">8 Weeks</i> a days per a week.
                    </p>
                </div>
            </div>
